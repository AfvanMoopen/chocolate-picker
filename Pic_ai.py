...
import os
import numpy as np
from Pic_solver import board_to_state, state_to_board, board_tructation, sort_positions
...
def AI_strategy(board, p_positions):
    '''
    Given a game state on Pic board in numpy array format, find the optimal action strategy.
    '''
