...
def board_to_state(board):
    '''
    Given a game state on Pic board in numpy array format, return a state in tuple format.
    '''
...
def state_to_board(state, size_x, size_y):
    '''
    Given a state in tuple format, return a game state on Pic board in numpy array format.
    '''
...
def board_tructation(board, action):
    '''
     Given a game state on Pic board in numpy array format and an action of player, return the resulted game state.
    '''
...
def find_p_positions(size_x, size_y):
    '''
    Find all p_positions of certain Pic rectangle of certain size.
    '''
    global p_positions
    global n_positions
